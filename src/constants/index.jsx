export const features = [
    {
      id: '0',
      icon: './src/assets/images/feature-1.png',
      caption: 'Easy integration',
      title: 'Work smarter not harder',
      text: "With Xora, tedious tasks are history. Automation and smart processes bring your productivity to new heights. It's like having an extra cup of coffee, but without the jitters.",
      button: {
        icon: './src/assets/images/magictouch.svg',
        title: 'Watch the demo',
      },
    },
    {
      id: '1',
      icon: './src/assets/images/feature-2.png',
      caption: 'Secure & trustworthy',
      title: 'Sleep easy, we got your back',
      text: 'Your data security is our priority. With state-of-the-art encryption and robust privacy controls, Xora helps keeps your information secure and locked up tighter than Fort Knox.',
      button: {
        icon: './src/assets/images/docs.svg',
        title: 'Read the docs',
      },
    },
  ];
  ...
  export const details = [
    {
      id: '0',
      icon: './src/assets/images/detail-1.png',
      title: 'AI automated video editing',
    },
    {
      id: '1',
      icon: './src/assets/images/detail-2.png',
      title: 'Collaborate with your team',
    },
    {
      id: '2',
      icon: './src/assets/images/detail-3.png',
      title: 'Ultra fast cloud-engine',
    },
    {
      id: '3',
      icon: './src/assets/images/detail-4.png',
  ...
  export const plans = [
    ...
    },
    {
      ...
      icon: './src/assets/images/triangle.svg',
      logo: './src/assets/images/plan-2.png',
    },
    {
      id: '2',
      title: 'Team',
      ...
      icon: './src/assets/images/hexagon.svg',
      logo: './src/assets/images/plan-3.png',
    },
  ];
  ...
  export const testimonials = [
    {
      ...
      role: 'Globalnomads',
      avatarUrl: './src/assets/images/testimonials/jessica-saunders.png',
      comment:
    ...
    },
    {
      ...
      avatarUrl: './src/assets/images/testimonials/mark-erixon.png',
      comment:
    ...
    },
    {
      ...
      name: 'Melanie Hurst',
      role: 'Cyberleap',
      avatarUrl: './src/assets/images/testimonials/melanie-hurst.png',
      comment:
    ...
    },
    {
      ...
      name: 'Alicia Barker',
      role: 'Cyberleap',
      avatarUrl: './src/assets/images/testimonials/alicia-barker.png',
      comment:
    ...
    },
    {
      ...
      name: 'Becky Snider',
      role: 'Floclips',
      avatarUrl: './src/assets/images/testimonials/becky-snider.png',
      comment:
    ...
    },
    {
      ...
      name: 'Jim Bradley',
      role: 'Vid capital intl',
      avatarUrl: './src/assets/images/testimonials/jim-bradley.png',
      comment:
  ...
  export const logos = [
    {
      id: '0',
      title: 'Afterpay',
      url: './src/assets/images/logos/afterpay.svg',
      width: 156,
      height: 48,
    },
    {
      id: '1',
      title: 'Amplitude',
      url: './src/assets/images/logos/amplitude.svg',
      width: 194,
      height: 48,
    },
    {
      id: '2',
      title: 'Sonos',
      url: './src/assets/images/logos/sonos.svg',
      width: 115,
      height: 48,
    },
    {
      id: '3',
      title: 'Maze',
      url: './src/assets/images/logos/maze.svg',
      width: 142,
      height: 48,
    },
    {
      id: '4',
      title: 'Drips',
      url: './src/assets/images/logos/drips.svg',
      width: 77,
      height: 48,
    },
  ];
  ...
  export const socials = [
    {
      id: '0',
      title: 'x',
      icon: './src/assets/images/socials/x.svg',
      url: '#',
    },
    {
      id: '1',
      title: 'Threads',
      icon: './src/assets/images/socials/threads.svg',
      url: 'https://www.threads.net/login',
    },
    {
      id: '2',
      title: 'Instagram',
      icon: './src/assets/images/socials/instagram.svg',
      url: 'https://www.instagram.com/accounts/login/?hl=en',
    },
    {
      id: '3',
      title: 'Discord',
      icon: './src/assets/images/socials/discord.svg',
